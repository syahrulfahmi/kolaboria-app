...
<template>
  ...
  >
    <div class="mb-6 border-b border-neutral-100 pb-5">
      ...
      <p class="mt-1.5 text-body text-neutral-500">
      ...
      >
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <span class="text-caption text-neutral-500"
            >Akan ditampilkan di halaman pencarian project.</span
          >
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div class="flex flex-col gap-2">
          ...
          <span class="text-[13px] text-neutral-500"
            >Kategori membantu sistem merekomendasikan project ke talenta yang
            tepat.</span
          >
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          <span class="text-[13px] text-neutral-500">
            <template v-if="form.visibility === 'public'"
              >Project dapat dilihat oleh semua orang di Kolaboria.</template
            >
            <template v-else
              >Hanya orang yang kamu undang yang bisa melihat project
              ini.</template
            >
          </span>
        </div>
